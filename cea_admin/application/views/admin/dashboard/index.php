                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Versão do AdminLTE</span>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Seu computador</h3>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="text-center"><strong>Adicionar gráfico</strong></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p class="text-center text-uppercase"><strong>Recursos</strong></p>
                                            <div class="progress-group">
                                                <span class="progress-text">Espaço utilizado em disco</span>
                                            ...
                                            <div class="progress-group">
                                                <span class="progress-text">Memória utilizada</span>
